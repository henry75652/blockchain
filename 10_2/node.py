...
class Node():
    def __init__(self):
        ...
        self.client_list_server = []   #client(連接別人) 列表
            #白名單
        self.node_list = ['172.20.10.9 5000', '172.20.10.13 5001', '172.20.10.14 5002']
        self.ip_list = ['172.20.10.9', '172.20.10.13', '172.20.10.14']
        self.port_list = [5000, 5001, 5002]
        #init
        self.server_init()
        time.sleep(3)
                ...
                if type(port) != int:
                    ...
                    for _ in range(4):
                        if port == self.port_list[_]:
                            ...
                            print("block_list")
                            #calculate.calculate_num(False,None,None,self.server_port)
                            ip = self.server_ip
                # debug mode
