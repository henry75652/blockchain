    ...
    if(len(lMsg) > 1):  #['block', '56\\Mon Feb 21 14:29:13 2022\\177\\00079bcd42436498efda60b225436ec25c8db797be85775b0271bbba4a776ddf\\Hello\\0.0.0.0']
        ...
        if(lMsg[0] == "block"):
            ...
            try:
                ...
                if block.conv_str_to_block_zpk(lMsg[1])["msg"]["Tag"] == "Fake":
                    print("[false_bl_block]")
                    print("[specification_block]",block.conv_str_to_block_zpk(lMsg[1])["msg"]["Content"])
                    return {"tag":lMsg[0],"content":block.conv_str_to_block_zpk(lMsg[1])["msg"]["Content"]}
            except:
