...
class Node():
    def __init__(self):
        ...
        self.client_list_server = []   #client(連接別人) 列表
            #白名單
        self.node_list = ['172.30.4.219 5000', '172.30.4.219 5001', '172.30.4.219 5002', '172.30.4.219 5003']
        self.ip_list = ['172.30.4.219', '172.30.4.219', '172.30.4.219', '172.30.4.219']
