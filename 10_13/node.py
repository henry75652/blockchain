...
class Node():
    def __init__(self):
        ...
        self.client_list_server = []   #client(連接別人) 列表
            #白名單
        self.node_list = ['172.30.2.113 5000', '172.30.2.113 5001', '172.30.2.113 5002', '172.30.2.113 5003']
        self.ip_list = ['172.30.2.113', '172.30.2.113', '172.30.2.113', '172.30.2.113']
    ...
    def server_recv_runner(self,client):
        ...
        while self.flag_stop == "run":
            ...
            if (flag):
                ...
                """
                self.server_data.append({"msg":spec,"source":client.getpeername()[1]}) ###固定source做測試
