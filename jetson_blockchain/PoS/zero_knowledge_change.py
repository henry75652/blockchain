...
if __name__ == "__main__":
    ...
    nonce_list = []
    print("test_2",puzzle_columns(nonces))
    print("test_22",tuple(nonces))
    nonce_list.append(sender_solution)
    nonce_list.append(tuple(nonces))
    print("test_222",nonce_list)
    ...
    a = str(11148549993261740376608400235000542733864409239502467120)
    
    a_hex = hex(int(a))
    
    print("[test_hex]",a_hex)
    ...
    a_str = hex_to_string(a_hex)
    
    print("[test_str]",a_str)
